...
function main() {
  ...
  Extension.INSTANCE = window.location.hostname.split('.')[0];
...
if (window.location.host.includes("canvas") || window.location.host.includes("instructure"))
  main();
